...
CREATE TABLE Programs (STUDENT_REF_ID INT, PROGRAM_NAME VARCHAR(100), PROGRAM_START_DATE DATETIME, FOREIGN KEY (student_ref_id) REFERENCES students(student_id) );
...
CREATE TABLE Scholarship(STUDENT_REF_ID INT, SCHOLARSHIP_AMOUNT INT, SCHOLARSHIP_DATE DATETIME, FOREIGN KEY (student_ref_id) REFERENCES students(student_id)
);
...
Scholarship.SCHOLARSHIP_DATE FROM Students LEFT JOIN Scholarship ON Students.STUDENT_ID= Scholarship.STUDENT_REF_ID;
